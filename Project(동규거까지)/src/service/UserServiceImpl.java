...
/*		1.영화등록 및 삭제
	...
	public void choiceMovie(MovieVO mv) {
		...
		System.out.println("날짜를 선택해주세요 (최대 3일 이전) >\r "
...
////////////////////////////////////////////////////////////////////////////////
		...
		for(int i = 0; i < showDBLength; i++){
			if(mv.getMovieCode() == showDB.get(i).getMovieCode() && date.equals(showDB.get(i).getDate())){
				System.out.println("상영관 : " + show
						DB.get(i).getScreen() + "\t 시간 : " + showDB.get(i).getTime());
			}
		}
		...
		//System.out.println(Arrays.toString(seatTemp));
		int count = 0;
		String seatStr = "";
